...
The implementation of the MVC pattern can be found inside the folders:
...
The implementation of the States pattern can be found inside the folder:
-[States](src/main/java/com.t09g01.projeto/states)

An explanation can be seen in the following diagrams:
<p align="center">
  <img src="docs/images/UML/MVC.png" alt="MVC"/>
</p>
<p align="center">
  <b><i>Fig 1. MVC </i></b>
</p>
...
#### Implementation
<p align="center">
  <img src="docs/images/UML/states.png" alt="States"/>
</p>
<p align="center">
  <b><i>Fig 2. States </i></b>
</p>

<br>

<p align="center">
  <img src="docs/images/UML/gameLoop.png" alt="Game Loop"/>
</p>
<p align="center">
  <b><i>Fig 3. Game Loop </i></b>
</p>
...
This warning indicates that the code is using the platform's default character set implicitly. This can lead to inconsistent behavior across different JVM executions or incorrect behavior if the data source's encoding does not match the platform's default encoding. To avoid this issue, always specify the character set explicitly when performing encoding or decoding operations.

- warning: [EmptyCatch] Caught exceptions should not be ignored
  This warning highlights that an exception is being caught but not handled. Ignoring exceptions can lead to hidden bugs and make debugging difficult. It is important to handle exceptions appropriately, either by logging them, rethrowing them, or taking corrective actions.

- warning: [MissingCasesInEnumSwitch] Non-exhaustive switch; either add a default or handle the remaining cases: WATERGIRL_UP, WATERGIRL_DOWN, WATERGIRL_LEFT, and 4 others
  This warning indicates that a switch statement on an enum type does not handle all possible enum values. This can lead to unexpected behavior if an unhandled enum value is encountered. To resolve this, either add cases for all enum values or include a default case to handle any remaining values.
...
<p align="center">
  <img src="docs/images/tests/coverageReport.png" alt="Coverage Report"/>
</p>
<p align="center">
...
<p align="center">
  <img src="docs/images/tests/pitestReport.png" alt="Pitest Report"/>
</p>
<p align="center">
